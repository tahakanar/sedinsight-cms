...
function ServiceArticle({ service }: { service: ServiceDetail }) {
  return (
    <article className="space-y-8">
      ...
      >
        <h2 className="font-['Bricolage_Grotesque'] text-3xl font-black text-navy">
          Bu Hizmette Odaklandığımız Alanlar
        </h2>
      ...
      <motion.section
        ...
        className="rounded-3xl border border-[#0f2a44]/10 bg-white p-7 shadow-[0_12px_30px_rgba(15,42,68,0.08)]"
      >
        <h2 className="font-['Bricolage_Grotesque'] text-3xl font-black text-navy">Teslimatlar</h2>
      ...
      <motion.section
        ...
        className="rounded-3xl border border-[#0f2a44]/10 bg-white p-7 shadow-[0_12px_30px_rgba(15,42,68,0.08)]"
      >
        <h2 className="font-['Bricolage_Grotesque'] text-3xl font-black text-navy">Çalışma Akışı</h2>
...
export default function ServiceDetailPage() {
      ...
      <Layout>
        <section className="min-h-[60vh] grid place-items-center bg-[#f7f9fb] px-4">
          <div className="text-center">
            ...
            <p className="mt-3 text-gray">Aradığınız hizmet sayfası mevcut değil.</p>
            <Link
              href="/hizmetler"
  ...
  return (
    <ServiceDetailLayout service={service} services={services}>
