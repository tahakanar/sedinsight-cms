...
export default function ServicesPage() {
  return (
    <Layout>
      <section className="relative pt-34 pb-22 bg-navy overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-4xl mx-auto">
            ...
            >
              Planli, Olculebilir ve
              <br />
              Sonuca Odakli Hizmetler
            </motion.h1>
            <motion.p variants={fadeInLeft} className="mt-6 text-lg text-white/70 leading-relaxed">
              Dijital sureclerinizi sadece uygulamaya degil, isletme hedeflerine baglayan 4 temel
              hizmet adimi.
            </motion.p>
          </AnimatedSection>
        </div>
      ...
      <EffectiveSolutionsSection id="hizmet-sureci" />
      ...
      <section className="relative pt-16 pb-20 bg-navy overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Siradaki adim icin
            <span className="text-teal"> iletisime gecelim</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Hizmet kapsamini isletmeniz icin birlikte netlestirelim.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
